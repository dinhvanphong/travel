...
const AdminBlog = () => {
  ...
  return (
    <div className='w-[80%] px-5 py-5 h-[100vh] overflow-auto'>
      <h1 className='text-center text-2xl font-bold text-gray-800 p-[10px] mb-7'>Tạo bài viết mới</h1>
        ...
        <div>
          ...
          <div className="flex flex-wrap mb-6">
            <div className="flex items-center me-4 cursor-pointer">
              ...
              />
              <label htmlFor="red-radio" className="pl-2 text-sm font-medium text-gray-500 cursor-pointer">Miền Bắc</label>
            </div>
            <div className="flex items-center me-4 cursor-pointer">
              <input
              ...
              />
              <label htmlFor="green-radio" className="pl-2 text-sm font-medium text-gray-500 cursor-pointer">Miền Trung</label>
            </div>
            <div className="flex items-center me-4 cursor-pointer">
              <input
              ...
              />
              <label htmlFor="purple-radio" className="pl-2 text-sm font-medium text-gray-500 cursor-pointer">Miền Nam</label>
            </div>
          </div>
        </div>


        <label className="block mb-2 text-sm font-medium text-gray-900" htmlFor="multiple_files">Thêm ảnh <span className='text-red-600'>*</span></label>
        <input
