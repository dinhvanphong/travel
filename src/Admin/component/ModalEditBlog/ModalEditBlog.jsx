...
const ModalEditBlog = (props) => {
  const {blogEdit, setIsOpenModalEdit} = props
  ...
  return (
    <div id="static-modal" data-modal-backdrop="static" tabIndex="-1" aria-hidden="true" className="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 px-2 z-50 justify-center items-center w-full md:inset-0 h-[100%] max-h-full bg-[#1e1e1e6f]">
